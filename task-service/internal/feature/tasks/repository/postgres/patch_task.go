...
func (r *tasksRepository) PatchTask(ctx context.Context, task *core_domain.Task) (*core_domain.Task, error) {
	...
	row := r.pool.QueryRow(ctx, query, task.Title, task.Description, task.ID, task.Version)
